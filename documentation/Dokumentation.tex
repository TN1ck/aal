		...
		\subsection{Frontend}
			...
			\subsubsection{Styles}
				\paragraph{responsive}
					...
					Diese Art von Webapplikation ist etwas was es vorher so noch nicht gegeben hat, wodurch es auch kein passendes Framework für unsere Ansätze gab was heißt wir mussten uns selbst überlegen wie wir eine Ansicht auf jeglichem Endgerät, unabhängigi von der Auflösung zu ermöglichen. Wir haben uns dafür entschieden bei all unseren Elementen \code{em} als Größeneinheit zu benutzen, da diese je nach gesetzter Schriftgröße der Elternobjekts (In unserem Fall des bodys) die Größe proportional mitskaliert.

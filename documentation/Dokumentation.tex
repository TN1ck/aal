		...
		\subsection{Frontend}
			...
			\subsubsection{Services}
				...
				\paragraph{Social-Comparison-Service}
					...
					Ein \textsc{JSON}-Objekt wird als Antwort an das Frontend übergeben, weches die Daten dann visualisiert.

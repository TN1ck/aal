	...
	\section{Erweiterung}
		...
		\subsection{Bean hinzufügen}
			...
			\item{}	\code{receiveMessage(Message)}:  \\
				Hier können empfangene Nachrichten, mit einem \code{if}-Konstrukt und der Funktion \code{instanceof}, nach Typ gefiltert werden und entsprechend weiterverarbeitet werden. In unserem Projekt ist dies meißt die Übergabe des Nachrichteninhalts an das Frontend über einen Websocket-Channel.
